...
export type CropApiState = AppState<any, any> & {};

const initialState: CropApiState = {
  data: null,
  dataList: [],
...
export const CropApiStore = signalStore(
  ...
  withMethods((store: any) => {
    ...
    return {
      ...
      findByCropTypes: rxMethod<{cropTypeIds: Set<string> | any }>(
        switchMap((data: any) => {
          patchState(store, { loading: true, loaderMessage: 'Loading ...' });
          return cropApi.findByCropTypes(data.cropTypeIds, ).pipe(
            tapResponse({
              next: (data: CropListDTO[] | any[]) => {
                //patchState(
                  //store, 
                  // { 
                  //    data, 
      ...
      save: rxMethod<{crop: CropDTO | any }>(
        switchMap((data: any) => {
          patchState(store, { loading: true, loaderMessage: 'Loading ...' });
