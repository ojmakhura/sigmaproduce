...
import { DocumentApi } from '@app/service/bw/co/sigmaproduce/document/document-api';
...
export const DocumentApiStore = signalStore(
  ...
  withMethods((store: any) => {
    ...
    return {
      ...
      getAllPaged: rxMethod<{pageNumber: number | any , pageSize: number | any }>(
        switchMap((data: any) => {
          ...
          return documentApi.getAllPaged(data.pageNumber, data.pageSize, ).pipe(
            tapResponse({
              next: (data: Page<DocumentDTO> | any) => {
                //patchState(
                  //store, 
                  // { 
                  //    data, 
      ...
      upload: rxMethod<{target: TargetEntity | any , targetId: string | any , documentTypeId: string | any , file: MultipartFile | any }>(
        switchMap((data: any) => {
          patchState(store, { loading: true, loaderMessage: 'Loading ...' });
