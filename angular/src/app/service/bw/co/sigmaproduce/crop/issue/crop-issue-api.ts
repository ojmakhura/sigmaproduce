...
export class CropIssueApi {
    ...
    public getAllPaged(pageNumber: number | any , pageSize: number | any ): Observable<Page<CropIssueVO>[] | any[]> {
        ...
        return this.http.get<Page<CropIssueVO>[] | any[]>(this.path + `/all/paged?pageNumber=${pageNumber}&pageSize=${pageSize}`);
    }
    ...
    public search(criteria: string | any ): Observable<CropIssueVO[] | any[]> {
        ...
        return this.http.get<CropIssueVO[] | any[]>(this.path + `/search?criteria=${criteria}`);
    }
    ...
    public searchPaged(criteria: string | any , pageNumber: number | any , pageSize: number | any ): Observable<Page<CropIssueVO>[] | any[]> {
        ...
        return this.http.get<Page<CropIssueVO>[] | any[]>(this.path + `/search/paged?criteria=${criteria}&pageNumber=${pageNumber}&pageSize=${pageSize}`);
    }
