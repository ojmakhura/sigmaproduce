 ...
 * within {@link bw.co.sigmaproduce.crop.CropService}.
 */
public class CropServiceException
    extends RuntimeException
{
    /**
     * The serial version UID of this class. Needed for serialization.
     */
    private static final long serialVersionUID = 3751812715769977617L;

    /**
     * The default constructor for <code>CropServiceException</code>.
     */
    ...
    /**
     * Constructs a new instance of <code>CropServiceException</code>.
     *
     * @param throwable the parent Throwable
     */
    public CropServiceException(Throwable throwable)
    {
     ...
     */
    public CropServiceException(String message, Throwable throwable)
    {
