 ...
 * within {@link bw.co.sigmaproduce.crop.type.CropTypeService}.
 */
public class CropTypeServiceException
    extends RuntimeException
{
    /**
     * The serial version UID of this class. Needed for serialization.
     */
    private static final long serialVersionUID = 172122870684273956L;

    /**
     * The default constructor for <code>CropTypeServiceException</code>.
     */
    public CropTypeServiceException()
    {
        // Documented empty block
    }

    /**
     * Constructs a new instance of <code>CropTypeServiceException</code>.
     *
     * @param throwable the parent Throwable
     */
    public CropTypeServiceException(Throwable throwable)
    {
     ...
     */
    public CropTypeServiceException(String message)
    {
        super(message);
    }
     ...
     */
    public CropTypeServiceException(String message, Throwable throwable)
    {
