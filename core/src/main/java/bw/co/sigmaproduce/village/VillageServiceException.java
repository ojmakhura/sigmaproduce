 ...
 * within {@link bw.co.sigmaproduce.village.VillageService}.
 */
public class VillageServiceException
    extends RuntimeException
{
    /**
     * The serial version UID of this class. Needed for serialization.
     */
    private static final long serialVersionUID = 4320231708184970712L;

    /**
     * The default constructor for <code>VillageServiceException</code>.
     */
    public VillageServiceException()
    {
        // Documented empty block
    }

    /**
     * Constructs a new instance of <code>VillageServiceException</code>.
     *
     * @param throwable the parent Throwable
     */
    public VillageServiceException(Throwable throwable)
    {
     ...
     */
    public VillageServiceException(String message)
    {
        super(message);
    }
     ...
     */
    public VillageServiceException(String message, Throwable throwable)
    {
