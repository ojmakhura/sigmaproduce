 ...
 * within {@link bw.co.sigmaproduce.farm.cultivation.CultivationService}.
 */
public class CultivationServiceException
    extends RuntimeException
{
    /**
     * The serial version UID of this class. Needed for serialization.
     */
    private static final long serialVersionUID = -1434901755966415956L;

    /**
     * The default constructor for <code>CultivationServiceException</code>.
     */
    public CultivationServiceException()
    {
        // Documented empty block
    }

    /**
     * Constructs a new instance of <code>CultivationServiceException</code>.
     *
     * @param throwable the parent Throwable
     */
    public CultivationServiceException(Throwable throwable)
    {
     ...
     */
    public CultivationServiceException(String message)
    {
        super(message);
    }
     ...
     */
    public CultivationServiceException(String message, Throwable throwable)
    {
