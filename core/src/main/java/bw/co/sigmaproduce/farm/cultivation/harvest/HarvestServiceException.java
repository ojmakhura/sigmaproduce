 ...
 * within {@link bw.co.sigmaproduce.farm.cultivation.harvest.HarvestService}.
 */
public class HarvestServiceException
    extends RuntimeException
{
    /**
     * The serial version UID of this class. Needed for serialization.
     */
    private static final long serialVersionUID = -4708925152031386042L;

    /**
     * The default constructor for <code>HarvestServiceException</code>.
     */
    public HarvestServiceException()
    {
        // Documented empty block
    }

    /**
     * Constructs a new instance of <code>HarvestServiceException</code>.
     *
     * @param throwable the parent Throwable
     */
    public HarvestServiceException(Throwable throwable)
    {
     ...
     */
    public HarvestServiceException(String message)
    {
        super(message);
    }
     ...
     */
    public HarvestServiceException(String message, Throwable throwable)
    {
