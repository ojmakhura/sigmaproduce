    ...
    that a model called 'sigmaproduce' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /sigmaproduce J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Onalenna Junior Makhura/.m2/repository/sigmaproduce/
