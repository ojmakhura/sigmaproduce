...
/**
 * 
 * TODO: Model Documentation for bw.co.sigmaproduce.farm.cultivation.problem.CultivationProblemApi
 */
public interface CultivationProblemApi {
    ...
    public ResponseEntity<?> pagedSearch(@PathVariable(name = "pageNumber", required = false) Integer pageNumber, @PathVariable(name = "pageSize", required = false) Integer pageSize, @RequestParam(name = "criteria", required = true) CultivationCriteria criteria);
    ...
    public ResponseEntity<?> save(@RequestBody(required = true) CultivationProblemVO cultivationProblem);

    @GetMapping("search")
    @Operation(summary = "Search Farms", description = "Search farms based on the criteria")
    public ResponseEntity<?> search(@RequestParam(name = "criteria", required = false) CultivationCriteria criteria);
}