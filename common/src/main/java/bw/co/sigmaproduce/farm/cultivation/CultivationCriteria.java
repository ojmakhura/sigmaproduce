 ...
 * MODEL CLASS:  AndroMDAModel::backend::bw.co.sigmaproduce::farm::cultivation::CultivationCriteria
...
/**
 * TODO: Model Documentation for CultivationCriteria
 */
public class CultivationCriteria
    implements Serializable, Comparable<CultivationCriteria>
{
    /** The serial version UID of this class. Needed for serialization. */
    private static final long serialVersionUID = 4463611367153044524L;

    // Class attributes
    /**
     * TODO: Model Documentation for CultivationCriteria.farm
     */
    protected String farm;
    /**
     * TODO: Model Documentation for CultivationCriteria.crop
     */
    protected String crop;
    /**
     * TODO: Model Documentation for CultivationCriteria.village
     */
    protected String village;
    /**
     * TODO: Model Documentation for
     * CultivationCriteria.district
     */
     ...
     */
    public CultivationCriteria(final String farmIn, final String cropIn, final String villageIn, final String districtIn)
    {
        this.farm = farmIn;
        this.crop = cropIn;
    ...
    /**
     * Copies constructor from other CultivationCriteria
     *
     * @param otherBean Cannot be <code>null</code>
     * @throws NullPointerException if the argument is <code>null</code>
     */
    public CultivationCriteria(final CultivationCriteria otherBean)
    {
     ...
     * @param otherBean Cannot be <code>null</code>
     */
    public void copy(final CultivationCriteria otherBean)
    {
        if (null != otherBean)
        {
    ...
    public boolean equals(final Object object)
    {
        ...
        CultivationCriteria rhs = (CultivationCriteria) object;
     ...
     */
    public int compareTo(final CultivationCriteria object)
    {
        if (object==null)
        {
            return -1;
    ...
    public boolean equalProperties(final Object thatObject)
    {
        ...
        final CultivationCriteria that = (CultivationCriteria)thatObject;
        return
    ...
    // CultivationCriteria value-object java merge-point
}