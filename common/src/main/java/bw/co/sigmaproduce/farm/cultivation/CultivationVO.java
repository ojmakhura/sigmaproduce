 ...
 * MODEL CLASS:  AndroMDAModel::backend::bw.co.sigmaproduce::farm::cultivation::CultivationVO
 * STEREOTYPE:   ValueObject
 */
package bw.co.sigmaproduce.farm.cultivation;

import bw.co.sigmaproduce.crop.variety.CropVarietyList;
...
/**
 * TODO: Model Documentation for CultivationVO
 */
public class CultivationVO
    implements Serializable, Comparable<CultivationVO>
{
    /** The serial version UID of this class. Needed for serialization. */
    private static final long serialVersionUID = 641610833451629131L;

    // Class attributes
    /**
     * TODO: Model Documentation for CultivationVO.id
     */
    protected String id;
    /**
     * TODO: Model Documentation for CultivationVO.createdBy
     */
    protected String createdBy;
    /**
     * TODO: Model Documentation for CultivationVO.updatedBy
     */
    protected String updatedBy;
    /**
     * TODO: Model Documentation for CultivationVO.createdDate
     */
    protected LocalDateTime createdDate;
    /**
     * TODO: Model Documentation for CultivationVO.updatedDate
     */
    protected LocalDateTime updatedDate;
    /**
     * TODO: Model Documentation for CultivationVO.farm
     */
    protected FarmListVO farm;
    /**
     * TODO: Model Documentation for CultivationVO.cropVariety
     */
    protected CropVarietyList cropVariety;
    /**
     * TODO: Model Documentation for
     * CultivationVO.cultivationDate
     */
    protected LocalDate cultivationDate;
    /**
     * TODO: Model Documentation for
     * CultivationVO.exptectedHarvestDate
     */
    protected LocalDate exptectedHarvestDate;
    /**
     * TODO: Model Documentation for CultivationVO.size
     */
    protected Double size;
    /**
     * TODO: Model Documentation for CultivationVO.unit
     */
    protected Unit unit;
     ...
     * @param farmIn FarmListVO
     * @param cropVarietyIn CropVarietyList
     * @param cultivationDateIn LocalDate
     * @param exptectedHarvestDateIn LocalDate
     * @param sizeIn Double
     * @param unitIn Unit
     */
    public CultivationVO(final String idIn, final String createdByIn, final String updatedByIn, final LocalDateTime createdDateIn, final LocalDateTime updatedDateIn, final FarmListVO farmIn, final CropVarietyList cropVarietyIn, final LocalDate cultivationDateIn, final LocalDate exptectedHarvestDateIn, final Double sizeIn, final Unit unitIn)
    {
        this.id = idIn;
    ...
    /**
     * Copies constructor from other CultivationVO
     *
     * @param otherBean Cannot be <code>null</code>
     * @throws NullPointerException if the argument is <code>null</code>
     */
    public CultivationVO(final CultivationVO otherBean)
    {
        ...
        this.exptectedHarvestDate = otherBean.getExptectedHarvestDate();
     ...
     * @param otherBean Cannot be <code>null</code>
     */
    public void copy(final CultivationVO otherBean)
    {
        if (null != otherBean)
        {
            ...
            this.setExptectedHarvestDate(otherBean.getExptectedHarvestDate());
     ...
     * @return farm FarmListVO
     */
    public FarmListVO getFarm()
    {
        return this.farm;
    }
    ...
    /**
     * TODO: Model Documentation for CultivationVO.farm
     * @param value FarmListVO
     */
    public void setFarm(final FarmListVO value)
    {
        this.farm = value;
    }
     ...
     * @return cropVariety CropVarietyList
     */
    public CropVarietyList getCropVariety()
    {
    ...
    /**
     * TODO: Model Documentation for CultivationVO.cropVariety
     * @param value CropVarietyList
     */
    public void setCropVariety(final CropVarietyList value)
    {
     ...
     * TODO: Model Documentation for
     * CultivationVO.exptectedHarvestDate
     * Get the exptectedHarvestDate Attribute
     * @return exptectedHarvestDate LocalDate
     */
     ...
     * @param value LocalDate
     */
    public void setExptectedHarvestDate(final LocalDate value)
    {
        this.exptectedHarvestDate = value;
    }
    ...
    public boolean equals(final Object object)
    {
        ...
        CultivationVO rhs = (CultivationVO) object;
        return new EqualsBuilder()
            ...
            .append(this.getExptectedHarvestDate(), rhs.getExptectedHarvestDate())
     ...
     */
    public int compareTo(final CultivationVO object)
    {
        if (object==null)
        {
            return -1;
        ...
        return new CompareToBuilder()
            ...
            .append(this.getExptectedHarvestDate(), object.getExptectedHarvestDate())
    ...
    public int hashCode()
    {
        return new HashCodeBuilder(1249046965, -82296885)
            ...
            .append(this.getExptectedHarvestDate())
            .append(this.getSize())
            .append(this.getUnit())
            .toHashCode();
    }
    ...
    public String toString()
    {
        ...
        builder.append("\t,\"exptectedHarvestDate\" : \"" + this.getExptectedHarvestDate() + "\"");
    ...
    public boolean equalProperties(final Object thatObject)
    {
        ...
        final CultivationVO that = (CultivationVO)thatObject;
        return
            ...
            && equal(this.getExptectedHarvestDate(), that.getExptectedHarvestDate())
    ...
    // CultivationVO value-object java merge-point
}