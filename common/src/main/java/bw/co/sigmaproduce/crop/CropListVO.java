 ...
 * MODEL CLASS:  AndroMDAModel::backend::bw.co.sigmaproduce::crop::CropListVO
...
/**
 * TODO: Model Documentation for CropListVO
 */
public class CropListVO
    implements Serializable, Comparable<CropListVO>
{
    /** The serial version UID of this class. Needed for serialization. */
    private static final long serialVersionUID = 3670748614435027258L;

    // Class attributes
    /**
     * TODO: Model Documentation for CropListVO.id
     */
    protected String id;
    /**
     * TODO: Model Documentation for CropListVO.createdBy
     */
    protected String createdBy;
    /**
     * TODO: Model Documentation for CropListVO.updatedBy
     */
    protected String updatedBy;
    /**
     * TODO: Model Documentation for CropListVO.createdDate
     */
    protected LocalDateTime createdDate;
    /**
     * TODO: Model Documentation for CropListVO.updatedDate
     */
    protected LocalDateTime updatedDate;
    /**
     * TODO: Model Documentation for CropListVO.code
     */
    protected String code;
    /**
     * TODO: Model Documentation for CropListVO.name
     */
    protected String name;
    /**
     * TODO: Model Documentation for CropListVO.type
     */
    protected String type;
    /**
     * TODO: Model Documentation for CropListVO.typeId
     */
     ...
     * @param codeIn String TODO: Model Documentation for CropListVO.code
     * @param nameIn String TODO: Model Documentation for CropListVO.name
     * @param typeIn String TODO: Model Documentation for CropListVO.type
     */
    public CropListVO(final String codeIn, final String nameIn, final String typeIn)
    {
        this.code = codeIn;
        this.name = nameIn;
        this.type = typeIn;
     ...
     * @param nameIn String
     * @param typeIn String
     * @param typeIdIn String
     */
    public CropListVO(final String idIn, final String createdByIn, final String updatedByIn, final LocalDateTime createdDateIn, final LocalDateTime updatedDateIn, final String codeIn, final String nameIn, final String typeIn, final String typeIdIn)
    {
        this.id = idIn;
    ...
    /**
     * Copies constructor from other CropListVO
     *
     * @param otherBean Cannot be <code>null</code>
     * @throws NullPointerException if the argument is <code>null</code>
     */
    public CropListVO(final CropListVO otherBean)
    {
     ...
     * @param otherBean Cannot be <code>null</code>
     */
    public void copy(final CropListVO otherBean)
    {
        if (null != otherBean)
        {
    ...
    public boolean equals(final Object object)
    {
        ...
        CropListVO rhs = (CropListVO) object;
        return new EqualsBuilder()
            ...
            .append(this.getTypeId(), rhs.getTypeId())
            .isEquals();
    }
     ...
     */
    public int compareTo(final CropListVO object)
    {
        if (object==null)
        {
            return -1;
        ...
        return new CompareToBuilder()
            ...
            .append(this.getTypeId(), object.getTypeId())
            .toComparison();
    }
    ...
    public String toString()
    {
        ...
        builder.append("\t,\"typeId\" : \"" + this.getTypeId() + "\"");
        builder.append("}");
    ...
    public boolean equalProperties(final Object thatObject)
    {
        ...
        final CropListVO that = (CropListVO)thatObject;
        return
            ...
            && equal(this.getTypeId(), that.getTypeId())
        ;
    }
    ...
    // CropListVO value-object java merge-point
}